...
//!
//! ## C# оригинал
//! - `Proteus.AI/Models/NetworkFingerprint.cs`
//! - `Proteus.AI/Services/NetworkFingerprintProvider.cs`
...
mod tests {
    ...
    fn test_fingerprint_display() {
        let fp =
            NetworkFingerprint::new("Office", "Ethernet", "172.16.0.1", vec![], "172.16.0.0/16");
